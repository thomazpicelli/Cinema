...
public class Filme implements Serializable{
    ...
    public Filme(Diretor diretor, Genero genero, ListaAtores listaAtores, Distribuidora distribuidora, String nome, int classificacao, int ano, int duracao, tiposituacao situacao, String idioma) {
        this.diretor = diretor;
        this.genero = genero;
        this.listaAtores = listaAtores;
        this.distribuidora = distribuidora;
