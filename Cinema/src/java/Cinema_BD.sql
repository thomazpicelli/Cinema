...
Insert into Gerente(nome, login, senha) values('admin','admin','admin'),('Mario','mariosuzuki','senha'),('Sueli','suelivieira','senha');
...
Insert into Sala(numero, lotacao, especial, situacao) values(1, 80, 10, 'EXIBICAO'), (2, 70, 20, 'EXIBICAO'),(3, 50, 10, 'EXIBICAO'),(4, 50, 15, 'MANUTENÇÃO'),(5, 90, 30, 'ESPERA'),(6, 60, 5, 'ESPERA');
